...
public class FinalConvertor extends AbstractMachine implements FinalAltarCore.FinalAltarChargable , Laser.LaserChargable {
    ...
    static {
        ...
        int maxValue= Collections.max(map.keySet())+1;
    ...
    public void process(Block b, BlockMenu inv, SlimefunBlockData data) {
        ...
        while (true){
            ...
            ItemStack result=(randMaterial!=null&&randMaterial.isItem()&&!randMaterial.isAir())?
                new ItemStack(randMaterial,rand.nextInt( Math.max(1,randMaterial.getMaxStackSize()))+1):NULL_OUT.getInstance();
